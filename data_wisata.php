  ...
  <div class="container">
    <div class="row d-flex align-items-center justify-content-center">
      <div class="about-content col-lg-12">
        ...
        <p class="text-white link-nav">Halaman ini memuat informasi Bengkel Motor Kuantan Mudik</p>
      </div>
    </div>
  </div>
</section>
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                          <img src="<?php echo "uploads/" . $item->gambar; ?>" style="max-width: 300px; max-height: 300px;" />
                        </td>
                        <td><?php echo $item->alamat; ?></td>
                        <td><?php echo $item->no_handphone ?></td>
                        <td><?php echo $item->Jadwal; ?> WIB</td>
